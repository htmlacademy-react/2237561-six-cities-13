...
function OfferPage({fullOffers}: TOfferPageProps): JSX.Element {
  const {id} = useParams();
  const selectedOffer = fullOffers.find((offer) => offer.id === String(id));
              ...
              <div className="offer__name-wrapper">
                ...
                <button
                  className={`offer__bookmark-button${
                    selectedOffer && selectedOffer.isFavorite ? '--active' : ''
                  } button`}
                  type="button"
                />
